...
class Container_907b354c16 extends _PHPStan_2526f5004\Nette\DI\Container
{
	protected $tags = [
		'phpstan.rules.rule' => [
			'029' => true,
	...
	public function createService0445(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_907b354c16 $container)
			{
	...
	public function createServiceContainer(): Container_907b354c16
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'PHPRC' => 'C:\Users\elcor\AppData\Local\Temp\7EDB.tmp',
				...
				'VSCODE_PID' => '23584',
				'windir' => 'C:\WINDOWS',
				'XDEBUG_HANDLER_SETTINGS' => 'C:\Users\elcor\AppData\Local\Temp\7EDB.tmp|0|*|*|C:\wamp64\bin\php\php8.2.29\php.ini|3.4.7',
			],
		];
	}
