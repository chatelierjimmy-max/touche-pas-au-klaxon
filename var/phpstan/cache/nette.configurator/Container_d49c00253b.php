...
class Container_d49c00253b extends _PHPStan_2526f5004\Nette\DI\Container
{
	protected $tags = [
		'phpstan.rules.rule' => [
			'029' => true,
	...
	public function createService0445(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_d49c00253b $container)
			{
	...
	public function createServiceContainer(): Container_d49c00253b
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'LINES' => '29',
				'PHPRC' => 'C:\Users\elcor\AppData\Local\Temp\810.tmp',
				...
				'XDEBUG_HANDLER_SETTINGS' => 'C:\Users\elcor\AppData\Local\Temp\810.tmp|0|*|*|C:\wamp64\bin\php\php8.2.29\php.ini|3.4.7',
			],
		];
	}
