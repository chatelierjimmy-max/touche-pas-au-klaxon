...
class Container_097ff360fe extends _PHPStan_2526f5004\Nette\DI\Container
{
	protected $tags = [
		'phpstan.rules.rule' => [
			'029' => true,
	...
	public function createService0445(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_097ff360fe $container)
			{
	...
	public function createServiceContainer(): Container_097ff360fe
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'PHPRC' => 'C:\Users\elcor\AppData\Local\Temp\FECE.tmp',
				...
				'VSCODE_PID' => '23584',
				'windir' => 'C:\WINDOWS',
				'XDEBUG_HANDLER_SETTINGS' => 'C:\Users\elcor\AppData\Local\Temp\FECE.tmp|0|*|*|C:\wamp64\bin\php\php8.2.29\php.ini|3.4.7',
			],
		];
	}
